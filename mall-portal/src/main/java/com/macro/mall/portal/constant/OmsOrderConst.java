...
public final class OmsOrderConst {
    ...
    //订单审核状态01 - 确认通过|02 - 确认不通过
    public static final  String PHYSICAL_PIC_CONFIRM_STATUS_OK = "01";
    public static final  String PHYSICAL_PIC_CONFIRM_STATUS_NOOK = "02";
