...
public class PmsProductAttributeServiceImpl implements PmsProductAttributeService {
    ...
    @Override
    public List<PmsProductAttribute> getProductAttr(Long productAttributeCategoryId) {
        PmsProductAttributeExample example = new PmsProductAttributeExample();
        example.createCriteria()
                .andTypeEqualTo(0)
                .andProductAttributeCategoryIdEqualTo(productAttributeCategoryId);
        List<PmsProductAttribute> productAttributes = productAttributeMapper.selectByExample(example);
