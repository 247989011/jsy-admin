...
@ApiModel(description = "商品", value="PmsProduct")
@Getter
@Setter
@ToString
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty("商品主图的OSS存储路径")
    private String pic;
    @ApiModelProperty("商品的画册图片，连产品图片限制为5张，以逗号分割")
    private String albumPics;
    @ApiModelProperty(value = "图片存取方式：0-OSS | 1-FastDfs", hidden = true)
    private String picSaveWay;
    @ApiModelProperty(value = "fastdfs存储路径-组",hidden = true)
    private String picFastdfsGroup;
    @ApiModelProperty(value = "fastdfs存储路径-文件名", hidden = true)
    private String picFastdfsFullname;
    @ApiModelProperty(value = "oss存储路径", hidden = true)
